...
class Seed
  ...
  def generate_property_images
    ...
    @hill_houses.each do |house|
      ...
      Photo.create!(image: File.open(image_path.join(photos[0])), property: house, primary: true)
      Photo.create!(image: File.open(image_path.join(photos[1])), property: house)
      Photo.create!(image: File.open(image_path.join(photos[2])), property: house)
    end
    ...
    @pauls_boutiques.each do |boutique|
      photos = filenames.sample(3)
      Photo.create!(image: File.open(image_path.join(photos[0])), property: boutique, primary: true)
      Photo.create!(image: File.open(image_path.join(photos[1])), property: boutique)
      Photo.create!(image: File.open(image_path.join(photos[2])), property: boutique)
    end

    @the_rooms.each do |room|
      photos = filenames.sample(3)
      Photo.create!(image: File.open(image_path.join(photos[0])), property: room, primary: true)
      Photo.create!(image: File.open(image_path.join(photos[1])), property: room)
      Photo.create!(image: File.open(image_path.join(photos[2])), property: room)
    end

    @log_cabins.each do |cabin|
      photos = filenames.sample(3)
      Photo.create!(image: File.open(image_path.join(photos[0])), property: cabin, primary: true)
      Photo.create!(image: File.open(image_path.join(photos[1])), property: cabin)
      Photo.create!(image: File.open(image_path.join(photos[2])), property: cabin)
    end
  end
end
